 ...
 * Belgian variant with regional adaptations
 */

import { TranslationKeys } from './nl-NL';

export const nlBE: TranslationKeys = {
  common: {
    brandName: 'SIGNAALMAKERS',
    requestQuote: 'Vraag offerte aan',
    contact: 'Neem contact op',
    readMore: 'Lees meer',
    viewServices: 'Bekijk diensten',
    viewSectors: 'Bekijk sectoren',
    phone: 'Bel ons',
    email: 'Mail ons',
    serviceArea: 'Werkgebied',
    nationwide: 'Actief in België en Nederland',
  },
  ...
  home: {
    hero: {
      title: 'Databekabeling & netwerkbekabeling in België en Nederland',
      subtitle: 'Specialist in databekabeling en netwerkbekabeling (Cat6/Cat6A), audiokabels en camera-bekabeling. We trekken kabels, monteren af, labelen en leveren functioneel getest op met kabelplan. Actief in Antwerpen, Brussel, Gent, Leuven en heel België. Wij doen het voorwerk — MSP/IT-partners regelen inregeling en beheer.',
    ...
    usps: {
      ...
      infraFirst: {
        title: 'Infra-first',
        desc: 'Cat6/Cat6A, audio, camera - alle bekabeling voor infrastructuur. Professioneel aangelegd en afgewerkt.',
      },
      practicalDelivery: {
      ...
      patchCabinets: {
        ...
        desc: 'Kabelmanagement, paneelindeling en labeling. Overzichtelijk en beheersbaar.',
      },
      nationwide: {
        title: 'Actief in België',
        desc: 'Door heel België. Van Antwerpen tot Luik, van Brussel tot Gent - overal hetzelfde vakmanschap.',
      },
    },
    whoWeWorkFor: {
    ...
    serviceArea: {
      ...
      subtitle: 'Heel België en Nederland. Van Antwerpen tot Luik, van Brussel tot Gent. Bekabeling voor infrastructuur: netwerk, audio en camera. Voor MSP\'s, IT-bedrijven, serverruimtes, kantoren, retail, magazijnen en zorg.',
      mapTitle: 'Actief in België',
      mapDescription: 'Wij werken door heel België en Nederland. Bekabeling voor infrastructuur (netwerk, audio, camera) voor serverruimtes, kantoren, retail, magazijnen en zorg.',
    },
    blogSection: {
      title: 'Laatste blogs',
      readMore: 'Lees meer',
  ...
  sectors: {
    serverRooms: {
      seo: {
        ...
        description: 'Cat6A bekabeling voor serverruimtes en datacenters in België. 10 Gbps, strakke patchkasten, praktische oplevercheck. Voorwerk voor MSP/IT.',
        keywords: 'serverruimte bekabeling, datacenter bekabeling, Cat6A 10Gbps, patchkast datacenter, MSP bekabeling partner België',
      },
      hero: {
        title: 'Bekabeling voor serverruimtes & datacenters',
        subtitle: 'Cat6A bekabeling voor 10 Gbps, strakke patchkasten en praktische oplevercheck. Wij leggen de bekabeling — MSP/IT doet inregeling en beheer. Actief in heel België en Nederland.',
      },
      mainSection: {
    ...
    offices: {
      seo: {
        ...
        description: 'Bekabeling voor kantoren in België: netwerk, audio, camera\'s. Cat6/Cat6A, PoE, wifi-trajecten. Professioneel voorwerk voor MSP/IT.',
        keywords: 'kantoor bekabeling België, netwerkbekabeling kantoor, wifi bekabeling, Cat6A kantoor, MSP partner kantoor',
      },
      hero: {
        title: 'Bekabeling voor kantoren',
        subtitle: 'Netwerkbekabeling, audio en camera\'s voor moderne kantooromgevingen. Cat6/Cat6A, PoE, wifi-trajecten—professioneel en toekomstbestendig. Actief in heel België en Nederland.',
      },
      mainSection: {
    ...
    retail: {
      seo: {
        ...
        description: 'Bekabeling voor retail en horeca in België: kassa\'s, camera\'s, audio, netwerk. Cat6/Cat6A, PoE — snel, netjes, minimale verstoring.',
        keywords: 'retail bekabeling België, horeca bekabeling, kassa bekabeling, camera winkel, PoE bekabeling retail',
      },
      hero: {
        title: 'Bekabeling voor retail & horeca',
        subtitle: 'Bekabeling voor kassa\'s, camera\'s en audio. Cat6/Cat6A, PoE — snel, netjes en met minimale verstoring van de bedrijfsvoering. Actief in heel België en Nederland.',
      },
      mainSection: {
    ...
    warehouse: {
      seo: {
        ...
        description: 'Bekabeling voor magazijnen en logistiek in België: netwerk, scanners, camera\'s. Cat6/Cat6A, PoE — robuust en geschikt voor zware omgevingen.',
        keywords: 'magazijn bekabeling België, logistiek bekabeling, scanner bekabeling, warehouse netwerk, PoE magazijn',
      },
      hero: {
        title: 'Bekabeling voor magazijn & logistiek',
        subtitle: 'Robuuste bekabeling voor scanners, camera\'s en netwerk. Cat6/Cat6A, PoE — geschikt voor zware omgevingen. Actief in heel België en Nederland.',
      },
      mainSection: {
    ...
    education: {
      seo: {
        ...
        description: 'Bekabeling voor onderwijs en zorg in België: netwerk, camera\'s, audio. Cat6/Cat6A, PoE — veilig, gedocumenteerd en betrouwbaar.',
        keywords: 'onderwijs bekabeling België, zorg bekabeling, school netwerk, ziekenhuis bekabeling, PoE onderwijs',
      },
      hero: {
        title: 'Bekabeling voor onderwijs & zorg',
        subtitle: 'Betrouwbare infrastructuur voor scholen, ziekenhuizen en zorginstellingen. Cat6/Cat6A, PoE, audio — veilig en gedocumenteerd. Actief in heel België en Nederland.',
      },
      mainSection: {
  ...
  faq: {
    title: 'Veelgestelde vragen',
    subtitle: 'SIGNAALMAKERS – Bekabeling voor infrastructuur in België en Nederland',
    intro: 'Heb je vragen over bekabeling voor infrastructuur? Op deze pagina vind je antwoorden op de meest gestelde vragen over netwerk (Cat6/Cat6A), audiokabels, camera-bekabeling, patchkasten en certificeren. SIGNAALMAKERS werkt in België en Nederland als bekabelingspartner voor MSP\'s, IT-bedrijven en organisaties. Wij doen het voorwerk - MSP/IT doet inregeling en beheer.',
    ...
    common: {
      ...
      nationwide: {
        question: 'Zijn jullie in België actief?',
        answer: 'Ja, wij werken door heel België en Nederland. Van serverruimtes en kantoren tot retail, magazijnen, onderwijs en zorg. Bekabeling voor infrastructuur: netwerk (Cat6/Cat6A), audio en camera.',
      },
      cat6Difference: {
  ...
  subscriptions: {
    hero: {
      ...
      subtitle: 'Klaar met wachten op offertes en eindeloze levertijden? Met onze abonnementen heb je gegarandeerde capaciteit, vaste doorlooptijden en flinke kortingen op alles wat telt. Gewoon geregeld.',
    },
    benefits: {
      ...
      flexibility: {
        title: 'Flexibiliteit',
        desc: 'Max. 2 extra projectdagen per maand tegen lage boekingskost.',
      },
    },
    packages: {
      ...
      extraDays: {
        ...
        description: 'Heb je in een bepaalde maand meer capaciteit nodig? Boek maximaal 2 extra projectdagen per maand tegen een lage boekingskost:',
        essentialFee: '€99 boekingskost + dagprijs met 5% korting',
        priorityFee: '€79 boekingskost + dagprijs met 10% korting',
        expressFee: '€59 boekingskost + dagprijs met 15% korting',
      },
    },
    targetAudience: {
    ...
    faq: {
      ...
      a4: 'Je kunt maximaal 2 extra projectdagen per maand boeken tegen een lage boekingskost. De kortingen op uren en materiaal blijven van toepassing.',
    },
  },
  ...
  offerte: {
    seo: {
      title: 'Offerte aanvragen – Bekabeling voor infrastructuur België | SIGNAALMAKERS',
      description: 'Vraag een offerte aan voor netwerk, audio of camera-bekabeling in België. Cat6/Cat6A, PoE, gebalanceerde lijnen — gecertificeerd opgeleverd.',
      keywords: 'offerte bekabeling belgië, offerte infrastructuur belgië, Cat6A offerte belgië, netwerkbekabeling prijs belgië, MSP bekabeling offerte belgië',
    },
    hero: {
      title: 'Vraag een offerte aan',
      subtitle: 'Netwerk, audio of camera-bekabeling nodig in België? Vul het formulier in en wij nemen binnen 24 uur contact op voor een vrijblijvende offerte.',
    },
    benefits: {
      fast: {
      ...
      nationwide: {
        title: 'Actief in België',
        description: 'Door heel België – van Antwerpen tot Brussel en Gent',
      },
    },
    form: {
  ...
  footer: {
    ...
    privacy: 'Privacy',
    terms: 'Voorwaarden',
    copyright: '© 2025 SIGNAALMAKERS. Alle rechten voorbehouden.',
  },
};

...
export const nlNL = {
  ...
  home: {
    hero: {
      title: 'Databekabeling & netwerkbekabeling door heel Nederland',
      subtitle: 'Specialist in databekabeling en netwerkbekabeling (Cat6/Cat6A), audiokabels en camera-bekabeling. We trekken kabels, monteren af, labelen en leveren functioneel getest op met kabelplan. Voor serverruimtes, kantoren, retail, magazijnen en zorg/onderwijs — MSP/IT doet inregeling. Wij doen het voorwerk — MSP/IT-partners regelen inregeling en beheer.',
  ...
  services: {
    ...
    patchCabinets: {
      ...
      results: {
        title: 'Resultaat',
        items: [
          'Overzichtelijke kast waar je snel mee kunt werken',
      ...
      forMSP: {
        title: 'Voor MSP\'s',
        description: 'Een nette patchkast betekent dat jouw technici sneller kunnen werken. Minder tijd zoeken, minder fouten, meer grip op het netwerk.',
        benefits: [
          {
          ...
          {
            title: 'Beter beheer',
            desc: 'Je kunt in één oogopslag zien wat waar zit. Uitbreidingen plannen wordt makkelijker.',
          },
        ],
      },
      faqs: {
      ...
      faqs: {
        ...
        items: [
          ...
          },
          {
            ...
            answer: 'PoE (Power over Ethernet) betekent dat een IP-camera zowel data als stroom via één UTP-kabel krijgt. Dit scheelt apart stroomkabels trekken en maakt plaatsing flexibel. Je hebt wel een PoE-switch of injector nodig om de stroom te leveren.',
          },
          {
            question: 'Hoe ver kan een camera-kabel liggen?',
            answer: 'De maximale afstand voor Cat6/Cat6A bekabeling is 100 meter (van switch tot camera). Voor langere afstanden kun je glasvezel, PoE-extenders of extra switches gebruiken. We adviseren bij het ontwerp altijd over haalbare afstanden.',
          },
          {
          ...
          },
          {
            ...
            answer: 'Ja, altijd. Je krijgt een opleverdossier met meetrapporten, kabelplan, labeling-schema en foto\'s van de eindopstelling. Zo weet jouw beveiligingsbedrijf precies welke kabel waar naartoe loopt en kunnen zij direct camera\'s aansluiten.',
          },
        ],
      },
      sectors: {
    ...
    audio: {
      ...
      whatWeDo: {
        ...
        forWho: {
          ...
          items: [
            ...
            'Kantoren met vergaderruimtes en auditoriums',
      ...
      balancedLines: {
        ...
        description: 'Wij trekken gebalanceerde audiokabels voor professionele installaties. Storingsarme routes, afscherming tegen EMI en netjes afgewerkt. Alles gelabeld en gedocumenteerd. Zo kan jouw audio-partner direct aan de slag met inregeling.',
      },
      faqs: {
        title: 'Veelgestelde vragen',
        items: [
          ...
          {
            question: 'Welke kabel gebruik je voor audiokabels?',
          ...
          {
            question: 'Hoe voorkom je storing op audiokabels?',
    ...
    certification: {
      ...
      standard: {
        ...
        description: 'Deze praktische oplevercheck is standaard bij elk bekabelingstraject. Geen extra kosten. Het hoort er gewoon bij – zo weet je zeker dat de infrastructuur functioneert en klaar is voor beheer door MSP/IT.',
      },
      faqs: {
        title: 'Veelgestelde vragen',
        items: [
  ...
  sectoren: {
    ...
    items: {
      msp: {
        title: 'MSP Partners',
        description: 'De uitvoerende partner voor MSP\'s en IT-dienstverleners. Wij leggen de basis: bekabeling, WiFi en infrastructuur. Jij doet beheer.',
      },
      serverRooms: {
  ...
  sectors: {
    ...
    msp: {
      seo: {
        ...
        description: 'Bekabelingspartner achter de schermen voor MSP\'s. Wij doen alleen het voorwerk: netwerkbekabeling, databekabeling, infrastructuur. Geen concurrentie, white-label mogelijk.',
      ...
      whatWeDo: {
        ...
        intro: 'Wij richten ons volledig op de fysieke laag: professionele netwerkbekabeling en databekabeling in bedrijfsgebouwen, kantoren, winkels, scholen, zorglocaties en horeca.',
        sections: [
          {
      ...
      benefits: {
        ...
        items: [
          ...
          },
          {
            ...
            description: 'Je hoeft geen eigen bekabelingsploeg op te bouwen om te kunnen groeien. Met Signaalmakers als vaste partner kun je meer projecten verkopen en opleveren, zonder dat je personeelskosten meteen mee exploderen.',
          },
          {
      ...
      whiteLabel: {
        ...
        description: 'Wij werken 100% voor MSP\'s, system integrators en IT-dienstverleners. Wil je dat we white-label werken? Dan zijn wij "jullie bekabelingspartner" of "jullie monteurs". Voor de klant ben jij de regisseur – wij zijn de stille kracht op de achtergrond.',
      },
      summary: {
  ...
  about: {
    hero: {
      title: 'Bekabeling voor infrastructuur',
      subtitle: 'Netwerk, audio, camera\'s – Cat6/Cat6A, PoE, gebalanceerde lijnen. Wij leggen de bekabeling, jij als MSP/IT doet inregeling en beheer. Duidelijke scheiding, professioneel voorwerk en landelijk inzetbaar.',
    },
    whoWeAre: {
      title: 'Wie we zijn',
    ...
    cta: {
      ...
      subtitle: 'Of het nu gaat om een nieuw kantoorpand, uitbreiding van een bestaande omgeving, wifi-bekabeling voor access points of het moderniseren van oude bekabeling: SIGNAALMAKERS regelt het voor je — in heel Nederland.',
  ...
  contact: {
    hero: {
      ...
      subtitle: 'Netwerk, audio of camera-bekabeling nodig? Wij doen het voorwerk – jij als MSP/IT doet inregeling. Cat6/Cat6A, PoE, gebalanceerde lijnen — gecertificeerd opgeleverd. Landelijk werkzaam.',
    },
    form: {
    ...
    map: {
      ...
      serviceArea: 'Werkgebied:',
      serviceAreaName: 'Heel Nederland',
    },
  },
...
export type TranslationKeys = typeof nlNL;

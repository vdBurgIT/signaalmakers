...
import { Cable, Camera, CheckCircle2, GraduationCap, Shield, Volume2 } from 'lucide-react';
import BackgroundOverlay from '../../components/BackgroundOverlay';
import { useTranslation } from '../../i18n';

export default function Onderwijs() {
  const t = useTranslation();
  const sector = t.sectors.education;
  ...
  return (
    <>
      <SEO
        ...
        hreflangPath="/sectoren/onderwijs"
        breadcrumbs={[
          { name: 'Home', item: 'https://signaalmakers.nl/' },
          { name: t.nav.sectors, item: 'https://signaalmakers.nl/sectoren' },
          { name: t.sectoren.items.education.title, item: 'https://signaalmakers.nl/sectoren/onderwijs' }
        ]}
      />
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-gray-600 text-sm">
                  Cat6A bekabeling voor klaslokalen en werkplekken
                </p>
              </LocaleLink>
              ...
              >
                ...
                <p className="text-gray-600 text-sm">
                  Privacy-proof PoE bekabeling voor beveiliging
                </p>
              </LocaleLink>
              ...
              >
                ...
                <p className="text-gray-600 text-sm">
                  Gebalanceerde lijnen voor intercom en omroep
                </p>
              </LocaleLink>

...
import { Cable, Camera, CheckCircle2, ShoppingBag, Volume2 } from 'lucide-react';
import BackgroundOverlay from '../../components/BackgroundOverlay';
import { useTranslation } from '../../i18n';

export default function Retail() {
  const t = useTranslation();
  const sector = t.sectors.retail;
  ...
  return (
    <>
      <SEO
        ...
        hreflangPath="/sectoren/retail"
        breadcrumbs={[
          { name: 'Home', item: 'https://signaalmakers.nl/' },
          { name: t.nav.sectors, item: 'https://signaalmakers.nl/sectoren' },
          { name: t.sectoren.items.retail.title, item: 'https://signaalmakers.nl/sectoren/retail' }
        ]}
      />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-5xl mx-auto">
              ...
              {sector.features.map((feature, index) => (
                <div key={index} className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="w-16 h-16 bg-gradient-to-br from-[#FF6A00] to-[#E55F00] rounded-xl flex items-center justify-center text-white mb-6">
                    ...
                    {index === 1 && <Camera className="w-8 h-8" />}
            ...
            <div className="bg-gradient-to-br from-purple-50 to-gray-50 rounded-2xl p-8 shadow-lg mb-16">
              <h3 className="text-2xl font-bold text-[#0E243A] mb-6">{sector.specialSection.title}</h3>
              <p className="text-gray-700 leading-relaxed mb-6">
                {sector.specialSection.text}
              </p>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              >
                ...
                <p className="text-gray-600 text-sm">
                  Cat6 bekabeling voor kassa's en back-office
                </p>
              </LocaleLink>
              ...
              >
                ...
                <p className="text-gray-600 text-sm">
                  PoE bekabeling voor IP-camera's binnen en buiten
                </p>
              </LocaleLink>
              ...
              >
                ...
                <p className="text-gray-600 text-sm">
                  Gebalanceerde lijnen voor vaste speakers
                </p>
              </LocaleLink>

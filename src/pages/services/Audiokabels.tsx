...
import { Volume2, Cable, AlertCircle, CheckCircle2, ChevronDown, ChevronUp, Building2, ShoppingBag, Server } from 'lucide-react';
    ...
    <>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0E243A] mb-6 text-center">
              {t.services.audio.sectors.title}
            </h2>
            <p className="text-gray-600 text-center mb-12 leading-relaxed">
              {t.services.audio.sectors.description}
            </p>
